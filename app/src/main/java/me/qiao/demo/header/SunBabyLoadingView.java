...
public class SunBabyLoadingView extends View {
     ...
     * 默认宽高
     */
    private static final int DEFAULT_DIAMETER_SIZE = 160;
...
//        }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        // 计算太阳圆圈的半径
        sunRadius = (lineLength - lineLength * RATIO_ARC_START_X) * .5f *.5f;
...
//        initAnimaDriver();
    ...
    public void play(onAnimRepetListener listener){
        this.onAnimRepetListener = listener;
        initAnimaDriver();
    }
        ...
        rise2SlowAnima.addListener(new AnimatorListenerAdapter() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                sinkAnima.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
//                        rise1SlowAnima.start();
                        if(null!= onAnimRepetListener)
                            onAnimRepetListener.onAnimRepeat();
                        cancelSpinAnim();
                    }
                });
            }
    ...
    private ValueAnimator initRise1Animator() {
        ...
        rise1SlowAnima.setDuration(500);
    ...
    private void startSpinAnima() {
        if(spinAnima==null) {
            spinAnima = ValueAnimator.ofFloat(0, 360);
    ...
    private  onAnimRepetListener onAnimRepetListener;
    public interface onAnimRepetListener{
        void onAnimRepeat();
    }
}